...
#define nrn_init _nrn_init__nav6
#define _nrn_initial _nrn_initial__nav6
#define nrn_cur _nrn_cur__nav6
#define _nrn_current _nrn_current__nav6
#define nrn_jacob _nrn_jacob__nav6
#define nrn_state _nrn_state__nav6
#define _net_receive _net_receive__nav6 
#define _f_rates _f_rates__nav6 
#define rates rates__nav6 
#define states states__nav6 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_nav6", _hoc_setdata,
 "rates_nav6", _hoc_rates,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nav6 /hpc/home/ts490/dcfiber/nrnmechanism/Nav6.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lVm ) {
  ...
  _lQ10 = pow( q10 , ( ( celsius - 22.0 ) / 10.0 ) ) ;
   ...
   tau_s = 2.0 + 7400.0 / ( exp ( ( _lVm + 60.0 ) / 5.0 ) + exp ( - 1.0 * ( _lVm + 0.0 ) / 22.0 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/hpc/home/ts490/dcfiber/nrnmechanism/Nav6.mod";
static const char* nmodl_file_text = 
