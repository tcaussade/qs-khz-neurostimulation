...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 axnode /hpc/home/ts490/dcfiber/nrnmechanism/AXNODE.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/hpc/home/ts490/dcfiber/nrnmechanism/AXNODE.mod";
static const char* nmodl_file_text = 
  ...
  "	bmpC = 10\n"
  "	amA = 1.86\n"
  "	amB = 20.4 : 20.4 in paper. Dr McIntyre confirmed that figures were generated with modelDB code, i.e., 21.4\n"
  "	amC = 10.3\n"
  "	bmA = 0.086\n"
  "	bmB = 25.7\n"
  "	bmC = 9.16\n"
