...
for j,idx in enumerate(idx_ft):
    ...
    # Read the data
    path_qs = folder+label+"/spikestimestamp_ft"+ft_ref+"_amp"+str(amp_ref)+"_fiberD"+str(fD)+"_QS.txt"
    path_ih = folder+label+"/spikestimestamp_ft"+ft_ref+"_amp"+str(amp_ref)+"_fiberD"+str(fD)+"_IH.txt"
