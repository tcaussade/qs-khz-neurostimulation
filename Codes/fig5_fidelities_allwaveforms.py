...
labels = ["canonical", "asymmetric", "shifted"]


fid_qs = np.zeros( (len(ftrains), len(amplitudes), len(labels)) )
fid_ih = np.zeros( (len(ftrains), len(amplitudes), len(labels)) )
err    = np.zeros( (len(ftrains), len(amplitudes), len(labels)) )
...
# determine fcutoffs
fcut1 = np.zeros((len(amplitudes),len(labels)))
fcut2 = np.zeros((len(amplitudes),len(labels)))

fcut1_50 = np.zeros((len(amplitudes),len(labels)))
fcut2_50 = np.zeros((len(amplitudes),len(labels)))
